...
private:
    ...
    bool isCollidingSphereWithPlane(const PhysicsObject &sphere);
    bool isCollidingSphereWithSphere(const PhysicsObject &sphereOne, const PhysicsObject &sphereTwo);
    void resolveCollisionSphereWithPlane(PhysicsObject &sphere);
    void resolveCollisionSphereWithSphere(PhysicsObject &sphereOne, PhysicsObject &sphereTwo);

    void updatePhysics(float deltaTime);
    void updateShaderStorageBuffers();
